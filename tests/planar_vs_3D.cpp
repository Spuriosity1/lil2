...
void test_planar_vs_3d(const imat33_t& Z, ivec3_t e1, ivec3_t e2) {
    ...
    EXPECT_TRUE(ok_vals) << "planar FFT: buf2d[sl][n1,n2] == buf3d[sl][K(n1,n2)]";
    ...
    EXPECT_TRUE(ok_phase) << "make_phase_weights: matches SublatWeightMatrix::phase_factors on plane";
}
